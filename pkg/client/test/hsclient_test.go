...
func TestCreateShare(t *testing.T) {
	...
	Mux.HandleFunc(client.BasePath+"/tasks/", func(w http.ResponseWriter, r *http.Request) {
	...
	Mux.HandleFunc(client.BasePath+"/shares/test/objective-set", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(200)
		if r.Method != "POST" {
